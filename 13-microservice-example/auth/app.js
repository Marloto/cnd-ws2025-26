...
const BcryptPasswordHasher = require('./src/adapters/outgoing/mongodb/BcryptPasswordHasher');
const JwtTokenGenerator = require('./src/adapters/outgoing/mongodb/JwtTokenGenerator');
